...
router.get('/produtos/pagina', [ProdutosController, 'pagina']).as('produtos.pagina')
...
router.get('/produtos/:id/relacionados', [ProdutosController, 'relacionados']).as('produtos.relacionados')
